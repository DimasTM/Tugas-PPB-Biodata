...
public class MainActivity extends AppCompatActivity {
    ...
    public void Email(View view) {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","dimastanuji@gmail.com", null));
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Judul Email");
        startActivity(Intent.createChooser(emailIntent, "Send email..."));
    }

    public void Alamat(View view) {
        Uri uri = Uri.parse("https://maps.google.com/?q=-7.093086,110.3796189,18z");
